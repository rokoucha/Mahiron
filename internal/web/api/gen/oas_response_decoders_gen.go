...
func decodeGetLogoImageResponse(resp *http.Response) (res GetLogoImageRes, _ error) {
	...
	case 200:
		...
		case ct == "image/png":
			...
			var wrapper GetLogoImageOKHeaders
			wrapper.Response = response
			h := uri.NewHeaderDecoder(resp.Header)
	...
	case 304:
		// Code 304.
		return &GetLogoImageNotModified{}, nil
	case 404:
		// Code 404.
...
func decodeGetServerConfigResponse(resp *http.Response) (res GetServerConfigRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
	...
	// Default response.
	res, err := func() (res GetServerConfigRes, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
			return res, errors.Wrap(err, "parse media type")
		}
