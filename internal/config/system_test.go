	...
	tests := []struct {
		...
		},
		{
			...
			want: &SystemConfig{
				...
				Observability: ObservabilityConfig{ServiceName: "mahiron"}, MaxConcurrentJobs: 1, DatabasePath: "./db/mahiron.db", DataBroadcastCachePath: "./db/data-broadcast-cache.db", DataBroadcastCacheBytes: 128 * 1024 * 1024, DataBroadcastCacheMaxAgeDays: 14,
		...
		},
		{
			...
			want: &SystemConfig{
				Addresses: []ServerAddress{{Http: "localhost:40772"}}, LogLevel: "info",
				Observability: ObservabilityConfig{ServiceName: "mahiron"}, MaxConcurrentJobs: 4, DatabasePath: "./db/mahiron.db", DataBroadcastCachePath: "./db/data-broadcast-cache.db", DataBroadcastCacheBytes: 128 * 1024 * 1024, DataBroadcastCacheMaxAgeDays: 14,
				EpgRetentionDays: 3, EpgRetrievalTime: 600000, EpgStaleAfter: 7200000, LogoGatherTimeout: 1200000, ServiceScanTimeout: 30000,
			},
		},
		{
